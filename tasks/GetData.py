...
def dl_fm_query(dataPath):
    ...
    fmQueryUrl = "https://transition.fcc.gov/fcc-bin/fmq?call=&fileno=&state=&city=&freq=0.0&fre2=107.9&serv=-1&status=3&facid=&asrn=&class=&list=4&NextTab=Results+to+Next+Page%2FTab&dist=&dlat2=&mlat2=&slat2=&NS=N&dlon2=&mlon2=&slon2=&EW=W&size=9"
